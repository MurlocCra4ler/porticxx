[[noreturn]] void unreachable_rtti_call() {
  __builtin_trap();
}
...
struct __class_type_info {
    ...
    virtual void __do_find_public_src() const {
        unreachable_rtti_call();
    }

    virtual void __do_dyncast() const {
        unreachable_rtti_call();
    }

    virtual void __do_upcast() const {
        unreachable_rtti_call();
    }
};
