...
struct ctrl_block_ptr : ctrl_block_base {
    ...
    ctrl_block_ptr(T* p, Deleter d) : ptr(p), deleter(move(d)) {}

    void destroy_object() noexcept override { deleter(ptr); }
    void delete_this() noexcept override { delete this; }
};

template <typename T> struct ctrl_block_inplace : ctrl_block_base {
    ...
    void destroy_object() noexcept override { get_ptr()->~T(); }
    void delete_this() noexcept override { delete this; }
};
