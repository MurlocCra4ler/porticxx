...
__attribute__((noinline)) extern "C" void runtime_resume() {
...
__attribute__((noinline)) extern "C" void runtime_yield() {
    if (!is_runtime_suspended) {
...
__attribute__((export_name("_init"))) extern "C" void _init() {}

__attribute__((export_name("_start"))) extern "C" void _start() {
    // call constructors
    __wasm_call_ctors();
